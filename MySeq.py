...
# -*- coding: utf-8 -*-
"""
Created on Mon Jan 27 21:16:09 2020
...
class MySeq:
    ...
    def __init__(self, seq, tipo="protein"):
        self.seq = seq.upper()
        self.tipo = tipo
...
# =============================================================================
        ...
        for aa in seqAA:
            ...
            if aa == "_":
                for p in protsAtuais:
                    proteinas.append(MySeq(p,"proteína"))
                protsAtuais = []
            if aa != "_":
                for p in protsAtuais:
                    p=p+aa
    ...
    def maiorProteinaORFs(self):
        ...
        for orf in self.orfs():
            p=orf.maiorProteina()
            if p is not None and len(p)>len(larg):
                larg=p    
        return larg
